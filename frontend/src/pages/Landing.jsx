...
import { FiHeart, FiMessageCircle, FiUsers, FiShare2 } from 'react-icons/fi';
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans">
      ...
      <header className="fixed w-full flex justify-between items-center px-8 py-4 bg-white/90 backdrop-blur-md shadow-sm z-50">
        <div className="text-2xl font-black bg-gradient-to-r from-red-500 to-pink-500 bg-clip-text text-transparent transform hover:scale-105 transition duration-300">
          HAITZ-RENCONTRE
        </div>
      ...
      <section id="how" className="py-24 bg-white relative -mt-10 rounded-t-3xl shadow-[0_-10px_40px_rgba(0,0,0,0.1)] z-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Pourquoi choisir HAITZ-RENCONTRE ?</h2>
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-16">Ils ont trouvé l'amour ici</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <TestimonialCard 
              name="Sophie & Julien"
              image="https://images.unsplash.com/photo-1522529599102-193c0d76b5b6?auto=format&fit=crop&q=80&w=2070"
              text="Grâce à HAITZ-RENCONTRE, j'ai non seulement trouvé mon âme sœur, mais j'ai adoré l'expérience sociale du site !"
            />
            <TestimonialCard 
              name="Marc & Elena"
      ...
      <footer className="bg-gray-900 text-gray-400 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center">
          <div className="mb-8 md:mb-0 text-center md:text-left">
            <h3 className="text-2xl font-black text-white mb-2">HAITZ-RENCONTRE</h3>
        ...
        <div className="text-center mt-8 text-sm opacity-50">
          &copy; {new Date().getFullYear()} HAITZ-RENCONTRE. Tous droits réservés.
        </div>
      </footer>
    </div>
  );
